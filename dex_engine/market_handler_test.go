...
func (s *marketHandlerSuite) SetupTest() {
	...
	token := &models.Token{
		Name:     "HOT",
		Symbol:   "HOT",
		Address:  os.Getenv("NSK_WETH_TOKEN_ADDRESS"),
		Decimals: 18,
	}
	...
	s.marketHandler.novaEngine.RegisterOrderbookActivitiesHandler(RedisOrderbookActivitiesHandler{})
}
...
func newModelOrder(side string, price, amount decimal.Decimal) *models.Order {
	...
	id := getNovaOrderHashHexFromOrderJson(&orderJson)
