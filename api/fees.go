...
// Nova Relayer is in charge of sending transaction to Ethereum network.
...
// For a normal ERC20 token, a match on nova will cost about 180000 - 190000 GWei gas on Ethereum.
//
...
func calculateFee(price, amount decimal.Decimal, market *models.Market, address string) *feeDetail {
	...
	detail.HotDiscount = nova.GetHotFeeDiscount(address)
