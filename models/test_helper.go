...
func InitTestDBPG() {
	...
	Connect(os.Getenv("NSK_DATABASE_URL"))
	DB.LogMode(true)
...
func setEnvs() {
	_ = os.Setenv("NSK_DATABASE_URL", "postgres://postgres:postgres@localhost:5432/postgres_test?sslmode=disable")
	_ = os.Setenv("NSK_REDIS_URL", "redis://redis:6379/0")
	_ = os.Setenv("NSK_BLOCKCHAIN_RPC_URL", "http://127.0.0.1:8545")
	_ = os.Setenv("NSK_WETH_TOKEN_ADDRESS", "0x4a817489643a89a1428b2dd441c3fbe4dbf44789")
	_ = os.Setenv("NSK_USD_TOKEN_ADDRESS", "0xbc3524faa62d0763818636d5e400f112279d6cc0")
	_ = os.Setenv("NSK_NOVA_TOKEN_ADDRESS", "0x4c4fa7e8ea4cfcfc93deae2c0cff142a1dd3a218")
	_ = os.Setenv("NSK_PROXY_ADDRESS", "0x04f67e8b7c39a25e100847cb167460d715215feb")
