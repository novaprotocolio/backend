...
var apiURL = os.Getenv("NSK_API_URL")
...
// https://github.com/novaprotocolio/ethereum-test-node
...
func getNovaAuthenticationHeader() string {
...
func setReqHeader(req *http.Request) {
	...
	req.Header.Add("Nova-Authentication", getNovaAuthenticationHeader())
}
